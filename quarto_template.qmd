...
client: Some client
proj_number: 25xxx
proj_title: Some project title
cal_number: -ST-CAL-000Y
cal_title: Calculation title
proj_phase: Concept Design
...
header-includes:
  ...
  - \def\client{ {{< meta client >}} }
  - \def\logoClient{images/logo-client.png}
  - \def\projNo{ {{< meta proj_number >}} }
  - \def\projTitle{ {{< meta proj_title >}} }
  - \def\calcNumber{ {{< meta proj_number >}} {{< meta cal_number >}} }
  - \def\calcTitle{ {{< meta cal_title >}} }
  - \def\projPhase{ {{< meta proj_phase >}} }
---
