...
```{julia}
calc_res, diagram_m = check_moment_diagram_from_results(vres::Vector{RaftAnalysisResult}, raft::RaftFootingRect, backfill::Soil_AS4678; ψG=0.9, isFrustumVol=false)
```
