...
### Web, top root radius element, reduced to 114000 cycles, OK
...
tripper_passes_reduced = 114000

cycle1 = tripper_passes_reduced  # 1st wheel
cycle2 = tripper_passes_reduced  # 2nd wheel
...
```{julia}
n_cycles_remaining = 1.6tripper_passes
...
```{julia}
Δf1 = abs((79 + 5)MPa)   # max stress range due to normal operating, including operting wind
Δf2 = Δf1                # 2nd wheel
...
```{julia}
Δf1 = abs((64 - 0)MPa) # max stress range due to normal operating, including operting wind
Δf2 = Δf1
